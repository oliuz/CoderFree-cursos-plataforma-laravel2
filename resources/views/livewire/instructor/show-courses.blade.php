<div>
    <x-container class="py-8">
        <ul class="grid grid-cols-1 gap-4 text-gray-700">
            ...
            @forelse ($courses as $course)
                ...
                {{-- <li class="bg-white rounded-lg shadow-lg overflow-hidden flex items-stretch">
                    <img class="w-48 36 object-cover" src="{{Storage::url($course->image)}}" alt="">
